...
public class RdActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.ss_activity_rd);
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.free.validator.loan.homeloan.creditscrore.RdActivity.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                RdActivity.this.reset();
            }
        });
        ImageView imageView2 = (ImageView) findViewById(R.id.ic_back);
        this.ic_back = imageView2;
        imageView2.setOnClickListener(new View.OnClickListener() { // from class: com.free.validator.loan.homeloan.creditscrore.RdActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                RdActivity.this.startActivity(new Intent(RdActivity.this, Calculator_Act.class));
            }
        });
        ImageView imageView3 = (ImageView) findViewById(R.id.calculate_text_view);
        this.calculateTextView = imageView3;
        imageView3.setOnClickListener(new View.OnClickListener() { // from class: com.free.validator.loan.homeloan.creditscrore.RdActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                RdActivity.this.calculateFD();
            }
        });
        EditText editText = (EditText) findViewById(R.id.yearly_investment_amount_edit_text);
        this.ss_m_dpsit = editText;
        editText.addTextChangedListener(new TextWatcher() { // from class: com.free.validator.loan.homeloan.creditscrore.RdActivity.4
            ...
            public void afterTextChanged(Editable editable) {
                try {
                    RdActivity.this.ss_m_dpsit.removeTextChangedListener(this);
                    String obj = RdActivity.this.ss_m_dpsit.getText().toString();
                    if (obj != null && !obj.equals("")) {
                        if (obj.startsWith(".")) {
                            RdActivity.this.ss_m_dpsit.setText("0.");
                        }
                        if (obj.startsWith("0") && !obj.startsWith("0.")) {
                            RdActivity.this.ss_m_dpsit.setText("");
                        }
                        String replaceAll = RdActivity.this.ss_m_dpsit.getText().toString().replaceAll(",", "");
                        if (!obj.equals("")) {
                            RdActivity.this.ss_m_dpsit.setText(a(replaceAll));
                        }
                        EditText editText2 = RdActivity.this.ss_m_dpsit;
                        editText2.setSelection(editText2.getText().toString().length());
                    }
                    RdActivity.this.ss_m_dpsit.addTextChangedListener(this);
                } catch (Exception e) {
                    e.printStackTrace();
                    RdActivity.this.ss_m_dpsit.addTextChangedListener(this);
                }
    ...
    public void reset() {
        ...
        TextView textView = this.ss_totDeposit;
        textView.setText(getString(R.string.Rs) + "0.0");
        TextView textView2 = this.ss_totInterest;
